...
{
  `As far as first projects go, this one was pretty well done. I went through multiple iterations of drafts in fairly quick succession, utilizing SolidWorks Assemblies to rapidly prototype the different parts an how they interfaced together. The most challenging aspects of the project were due to relying too heavily on these assemblies. SolidWorks was still quite new to me at this time. While I felt confident in using it to create these 2D parts and 3D assemblies, I doubted my ability to make more complex things. I would often find that my design worked virtually, but that it did not fit well on the robot. The solution, which I was aware of, would be to create a virtual robot to test against. Brief attempts to do so were not successful, so this more wasteful but still effective process of physical prototyping was used instead. That process would only grow more refined throughout the rest of my IDEAS career.
`}
/>;
